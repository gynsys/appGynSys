...
def seed_notification_rules(db: Session, tenant_id: int):
    ...
    standard_rules = [
        ...
        },
        {
            ...
            "message_text_template": "👋 Hola! {patient_name}.\n\nDía 16 - Ventana de implantación",
            "channel": "dual",
            "send_time": "09:00"
        },
        {
        ...
        },
        {
            ...
            "message_text_template": "👋 Hola! {patient_name}.\n\nDía 20 - Importancia del descanso",
            "channel": "dual",
            "send_time": "21:00"
        },
        {
        ...
        },
        {
            ...
            "message_template": "👋 Hola! {patient_name}.\n\n{patient_name} ha completado su preconsulta para la cita del {appointment_date}.",
            "message_text_template": "👋 Hola! {patient_name}.\n\nPreconsulta completada por {patient_name}.",
            "channel": "dual",
            "send_time": "08:00"
        },
        {
