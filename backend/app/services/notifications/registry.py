...
NOTIFICATION_REGISTRY: List[Dict[str, Any]] = [
    ...
    { "type": "day_2_symptom_check", "category": "menstrual", "priority": 101, "title": "Día 2 - Chequeo de Dolor", "message": "👋 Hola! {patient_name}.\n\n¿Cómo te sientes hoy? Registra dolor, flujo y otros síntomas.", "logic": lambda c: is_day(c, 2) },
    { "type": "day_3_hydration", "category": "menstrual", "priority": 102, "title": "Día 3 - Hidratación", "message": "👋 Hola! {patient_name}.\n\n💧 Recuerda beber mucha agua para ayudar con los cólicos.", "logic": lambda c: is_day(c, 3) },
    { "type": "day_4_mood_track", "category": "menstrual", "priority": 103, "title": "Día 4 - Estado de Ánimo", "message": "👋 Hola! {patient_name}.\n\n¿Cómo está tu ánimo hoy? Registra tus emociones.", "logic": lambda c: is_day(c, 4) },
    { "type": "day_5_flow_decrease", "category": "menstrual", "priority": 104, "title": "Día 5 - Fin de Chequeo", "message": "👋 Hola! {patient_name}.\n\nTu flujo debería estar disminuyendo. ¿Cómo va tu periodo?", "logic": lambda c: is_day(c, 5) },
    ...
    { "type": "rhythm_after_period_1", "category": "rhythm", "priority": 150, "title": "Día Seguro - Post Periodo (1/5)", "message": "👋 Hola! {patient_name}.\n\nEstás en tu primer día infértil post-periodo. Riesgo de embarazo muy bajo.", "logic": lambda c: c.get("days_after_period") == 1 },
    { "type": "rhythm_after_period_2", "category": "rhythm", "priority": 151, "title": "Día Seguro - Post Periodo (2/5)", "message": "👋 Hola! {patient_name}.\n\nFase infértil activa. Puedes aplicar el método del ritmo de forma segura.", "logic": lambda c: c.get("days_after_period") == 2 },
    { "type": "rhythm_after_period_3", "category": "rhythm", "priority": 152, "title": "Día Seguro - Post Periodo (3/5)", "message": "👋 Hola! {patient_name}.\n\nContinúa tu ventana de días seguros según el método del ritmo.", "logic": lambda c: c.get("days_after_period") == 3 },
    { "type": "rhythm_after_period_4", "category": "rhythm", "priority": 153, "title": "Día Seguro - Precaución Pronto (4/5)", "message": "👋 Hola! {patient_name}.\n\nPenúltimo día de tu fase segura post-periodo antes de ovular.", "logic": lambda c: c.get("days_after_period") == 4 },
    { "type": "rhythm_after_period_5", "category": "rhythm", "priority": 154, "title": "Día Seguro - Precaución Hoy (5/5)", "message": "👋 Hola! {patient_name}.\n\nÚltimo día seguro de esta fase. A partir de mañana tu ventana fértil comienza.", "logic": lambda c: c.get("days_after_period") == 5 },

    { "type": "rhythm_before_period_5", "category": "rhythm", "priority": 155, "title": "Día Seguro - Pre Periodo (1/5)", "message": "👋 Hola! {patient_name}.\n\nTu ventana fértil terminó. Inician tus 5 días seguros antes del próximo periodo.", "logic": lambda c: c.get("days_before_period") == 5 },
    { "type": "rhythm_before_period_4", "category": "rhythm", "priority": 156, "title": "Día Seguro - Pre Periodo (2/5)", "message": "👋 Hola! {patient_name}.\n\nFase infértil pre-menstrual. Probabilidad de embarazo muy baja.", "logic": lambda c: c.get("days_before_period") == 4 },
    { "type": "rhythm_before_period_3", "category": "rhythm", "priority": 157, "title": "Día Seguro - Pre Periodo (3/5)", "message": "👋 Hola! {patient_name}.\n\nContinúan tus días seguros según el método del ritmo.", "logic": lambda c: c.get("days_before_period") == 3 },
    { "type": "rhythm_before_period_2", "category": "rhythm", "priority": 158, "title": "Día Seguro - Pre Periodo (4/5)", "message": "👋 Hola! {patient_name}.\n\nTu periodo está por llegar. Día completamente seguro para relaciones.", "logic": lambda c: c.get("days_before_period") == 2 },
    { "type": "rhythm_before_period_1", "category": "rhythm", "priority": 159, "title": "Día Seguro - Pre Periodo (5/5)", "message": "👋 Hola! {patient_name}.\n\nÚltimo día antes de tu periodo. Fase completamente infértil.", "logic": lambda c: c.get("days_before_period") == 1 },
