# 🔧 Solución: npm/pnpm no se reconoce
...
Esto significa que **Node.js no está instalado** o no está en el PATH, o que pnpm no está instalado.
...
### 2. Instalar pnpm
Después de instalar Node.js, instala pnpm:
```powershell
npm install -g pnpm
```
