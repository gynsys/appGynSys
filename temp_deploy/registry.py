...
NOTIFICATION_REGISTRY: List[Dict[str, Any]] = [
    ...
    { "type": "day_2_symbol_check", "category": "menstrual", "priority": 101, "title": "Día 2 - Chequeo de Dolor", "message": "¿Cómo te sientes hoy? Registra dolor, flujo y otros síntomas.", "logic": lambda c: is_day(c, 2) },
    ...
    { "type": "day_9_fertile_approaching", "category": "menstrual", "priority": 108, "title": "Día 9 - Ventana Fértil Cerca", "message": "💞 Se aproxima tu ventana fértil. Estate atenta.", "logic": lambda c: is_day(c, 9) },
    { "type": "day_10_fertile_start", "category": "menstrual", "priority": 109, "title": "Día 10 - Ventana Fértil", "message": "💞‍🔥 Inicia tu ventana fértil. Alta probabilidad de concepción.", "logic": lambda c: is_day(c, 10) },
    ...
    { "type": "day_22_pms_start", "category": "menstrual", "priority": 121, "title": "Día 22 - Posible SPM", "message": "💆 Inician posibles síntomas premenstruales. Cuídate.", "logic": lambda c: is_day(c, 22) },
    ...
    *[
    ...
    { "type": "prenatal_bleeding", "category": "prenatal", "priority": 1, "title": "🩸 Sangrado", "message": "Sangrado durante el embarazo requiere atención médica inmediata.", "logic": lambda c: has_event(c, "reduced_movement") },
