      ...
      <div className="fixed bottom-6 right-6 flex flex-col space-y-3 z-40 items-center">
        ...
        {doctor.whatsapp_url && (
          <a
            ...
            className="px-4 py-2 rounded-full font-medium text-sm text-white shadow-lg transform hover:scale-105 transition-all duration-200 flex items-center justify-center animate-pulse"
            style={{
              backgroundColor: '#25D366', // Original WhatsApp Green
            }}
          >
            <svg className="mr-2 w-5 h-5 fill-current" viewBox="0 0 24 24">
