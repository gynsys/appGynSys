                ...
                {isMobile && (
                  <div className="h-[100dvh] bg-gray-50 dark:bg-gray-900 overflow-hidden flex flex-col">
                    ...
                    {isMobileFullscreen ? (
                      ...
                      /* Mobile Main Content Area (Not Fullscreen) */
                      <div className="flex-1 flex flex-col items-center justify-start pt-4 p-6 overflow-hidden">
                        {(!generatedContent || mobileActionPerformed) ? (
                          <div className="h-full w-full flex flex-col items-center justify-center bg-white dark:bg-gray-800 rounded-[40px] shadow-sm border-2 border-dashed border-gray-100 dark:border-gray-700 animate-pulse text-center p-10">
                          ...
                          <div className="w-full flex flex-col items-center justify-center space-y-4 animate-fadeIn">
                            ...
                            <div className="w-full bg-white dark:bg-gray-800 p-6 rounded-[40px] shadow-lg shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700 text-center animate-slideUp">
