                            ...
                            <div className="flex-1 flex flex-col items-center justify-start pt-4 p-6 overflow-hidden">
                              {(!generatedContent || mobileActionPerformed) ? (
                                ...
                                <div className="w-full flex flex-col items-center justify-center space-y-4 animate-fadeIn">
                                  {/* Mobile Action Center (C1) - Full Width & Horizontal Buttons */}
                                  <div className="w-screen -mx-6 bg-white dark:bg-gray-800 p-6 shadow-lg shadow-gray-200/50 dark:shadow-none border-y border-gray-100 dark:border-gray-700 text-center animate-slideUp">
