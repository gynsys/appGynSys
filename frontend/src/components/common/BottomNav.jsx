 ...
 */
export const BottomNav = ({ items, theme = '#4f46e5', className = '' }) => {
    return (
        <nav
...
/**
 * Icon components for better customization
 */
export const NavIcons = {
    ...
    Calendar: (props) => <Calendar className="w-5 h-5" {...props} />,
    Blog: (props) => <Newspaper className="w-5 h-5" {...props} />,
};
