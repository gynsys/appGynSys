          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <div className={(darkMode || isDarkMode) ? 'dark w-full flex justify-center' : 'w-full flex justify-center'}>
                <Dialog.Panel className={`w-full ${sizeClasses[size]} transform overflow-hidden rounded-2xl bg-white dark:bg-gray-900 dark:text-white px-4 py-4 md:p-6 text-left align-middle shadow-xl transition-all border border-gray-200 dark:border-gray-700 mt-[10px] max-h-[82vh] flex flex-col`}>
