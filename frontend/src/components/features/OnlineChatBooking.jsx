...
export default function OnlineChatBooking({ doctorId, doctor = {}, onClose, isOpen = true, settings: propSettings }) {
    ...
    return (
        <div className={`fixed inset-0 z-50 flex items-center justify-center p-4 transition-opacity duration-300 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
            ...
            {/* Modal Content */}
            <div className={`bg-white dark:bg-gray-800 rounded-t-3xl md:rounded-2xl shadow-2xl w-full md:w-[380px] h-[85vh] md:h-[500px] overflow-hidden relative transform transition-all duration-300 ${isVisible ? 'scale-100 translate-y-0' : 'scale-95 translate-y-4'} absolute bottom-0 md:relative`}>
