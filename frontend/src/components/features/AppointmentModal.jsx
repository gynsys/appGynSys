  ...
  return (
    <Transition show={isOpen} as={Fragment}>
      <div className="relative z-50">
        ...
        >
          <div
            className="fixed bottom-0 left-0 right-0 w-full md:w-[360px] h-[80vh] md:h-auto md:max-h-[600px] md:bottom-24 md:right-8 md:left-auto bg-white dark:bg-gray-800 rounded-t-3xl md:rounded-2xl shadow-2xl border-t-2 md:border-2 border-x-0 border-b-0 md:border-x-2 md:border-b-2 overflow-hidden flex flex-col transition-all duration-300"
