          ...
          <div className="flex justify-center">
            ...
            >
              <button
                onClick={prev}
                aria-label="Anterior"
                className="absolute left-[2px] top-1/2 transform -translate-y-1/2 z-20 bg-black bg-opacity-30 hover:bg-opacity-50 text-white rounded-full p-2 md:p-3"
              >
              ...
              <button
                ...
                className="absolute right-[2px] top-1/2 transform -translate-y-1/2 z-20 bg-black bg-opacity-30 hover:bg-opacity-50 text-white rounded-full p-2 md:p-3"
              >
                <svg className="w-4 h-4 md:w-5 md:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
